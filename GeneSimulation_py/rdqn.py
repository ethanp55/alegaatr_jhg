...
class RDQN(AbstractAgent):
    ...
    def save_network(self) -> None:
        ...
        self.model.save('../GeneSimulation_py/rdqn_model/model.keras')

        with open('../GeneSimulation_py/rdqn_model/scaler.pickle', 'wb') as f:
            pickle.dump(self.scaler, f)

    def load_network(self) -> None:
        # Load the network and scaler
        self.model = keras.models.load_model('../GeneSimulation_py/rdqn_model/model.keras')
        self.scaler = pickle.load(open('../GeneSimulation_py/rdqn_model/scaler.pickle', 'rb'))
